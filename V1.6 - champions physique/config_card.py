...
card_set = {
    ...
    "Katarina": {
        ...
        "atk": 2,
        "pv": 2,
        "effect": ["charge", "insaisissable"],
        "description": "charge, insaisissable"
    },
    "Zed": {
        "type": "fighter",
        "classe": "Thot",
    ...
    "Chaman Cognefer": {
        ...
        "pv": 3,
        "effect": ["inv"],
        "description": "inv: pioche 1 rituel"
    },
    "Guerrier Cognefer": {
        "type": "fighter",
        "classe": "Marduk",
        ...
        "pv": 4,
        "effect": ["inv"],
        "description": "compte pour 1 lv de plus sur rituel"
    },
    "Atra Hasis": {
        "type": "fighter",
        "classe": "Inconnu",
        ...
        "pv": 5,
        "effect": ["inv"],
        "description": "inv: place 5 marques dans ton deck, quand vous les piochez toute, vous gagnez la partie"
    },
    "Kodo de livraison": {
        "type": "fighter",
        "classe": "Enki",
        ...
        "pv": 3,
        "effect": ["inv"],
        "description": "inv: pioche 1 bête, réduit son cout en mana de 1"
    },
    "Kodo du désert": {
        "type": "fighter",
        "classe": "Enki",
        ...
        "pv": 2,
        "effect": ["inv"],
        "description": "inv: donne +1/+1 à un bête dans ta main"
    },
    "Garuda": {
        "type": "fighter",
        "classe": "Ishtar",
        ...
        "pv": 5,
        "effect": ["mort"],
        "description": "mort: invoque 2 Vautour 2/2 charge"
    },
    ...
    "Piège à ressort": {
        ...
        "cost": 2,
        "target": ["ennemy"],
        "description": "renvoie un combattant adverse dans sa main"
    },
    "Trait de la mort": {
        "type": "spell",
        "classe": "Thot",
        "cost": 4,
        "target": ["ennemy"],
        "description": "inflige 3 dégats aux unités d'une ligne"
    },
    "Dague tranchante": {
        "type": "spell",
        "classe": "Thot",
        "cost": 1,
        "target": ["ally"],
        "description": "donne +2/+0 à un allié"
    },
    "Tablette de la destinée": {
        "type": "spell",
        "classe": "Thot",
        "cost": 8,
        "target": ["none"],
        "description": "soigne votre avatar de 10, réduit son cout en main lorsque le passif thot est activé"
    },
    "Rembobinage": {
        "type": "spell",
        "classe": "Thot",
        "cost": 5,
        "target": ["none"],
        "description": "repousse tous les combattants adverses de frontline à backline"
    },
    "Clepsydre": {
        "type": "spell",
        "classe": "Thot",
        "cost": 1,
        "target": ["none"],
        "description": "donne 2 mana au prochain tour"
    },
    "Poussière temporelle": {
        ...
        "cost": 2,
        "target": ["ennemy"],
        "description": "inflige 2 dégats à une unité, si elle meurt, gagne 2 mana"
    },
    "Écran de fumée": {
        "type": "spell",
        "classe": "Thot",
        "cost": 0,
        "target": ["ally"],
        "description": "renvoie un combattant allié dans ta main, il coute 1 de moins"
    },
    "Instinct bestial": {
        "type": "spell",
        "classe": "Ishtar",
        "cost": 2,
        "target": ["none"],
        "description": "pioche 2 cartes, réduit le cout des combattants de 1 et défausse les autres"
    },
    "Tempête du désert": {
        "type": "spell",
        "classe": "Enlil",
        "cost": 4,
        "target": ["none"],
        "description": "détruits les combattants avec 4 atk ou plus"
    },
    "Rebondissement": {
        "type": "spell",
        "classe": "Inconnu",
        "cost": 2,
        "target": ["none"],
        "description": "les 2 joueurs mélangent leur main dans leur deck et repiochent le meme nombre de cartes"
    },
    "Tentacules déchainées": {
        "type": "spell",
        "classe": "Kraken",
        "cost": 3,
        "target": ["ennemy", "none"],
        "description": "inflige des dégats équivalents à l'attaque de vos tentacules"
    },
    "Avarice": {
        "type": "spell",
        "classe": "Enlil",
    ...
    "Baton du magicien": {
        ...
        "cost": 2,
        "target": ["ally"],
        "description": "donne +1/+1 à un mage et en ajoute une copie à votre main"
    },
    "Soufle d'Absu": {
        "type": "spell",
        "classe": "Enki",
        "cost": 5,
        "target": ["ennemy"],
        "description": "inflige x dégats à un combattant, célestial : dégats percants"
    },
    "Brevage de la sorcière": {
        "type": "spell",
        "classe": "Marduk",
        "cost": 3,
        "target": ["ally"],
        "description": "choisis un orc allié qui a attaqué ce tour pour lui donner une seconde attaque"
    },
    "Spores": {
        "type": "spell",
        "classe": "Inconnu",
        "cost": 4,
        "target": ["ennemy"],
        "description": "inflige 4 dégats à un combattant, s'il meurt, place 2 Infection dans le deck adverse"
    },
    ...
    "Fragment du destin 1": {
        "type": "spell",
        "classe": "Inconnu",
        "cost": 5,
        "target": ["none"],
        "description": "si vous possèdez les 5 Fragment du destin en main, vous gagnez la partie"
    },
    "Fragment du destin 2": {
        "type": "spell",
        "classe": "Inconnu",
        "cost": 5,
        "target": ["none"],
    ...
    "Rituel forestier": {
        ...
        "classe": "Alchimiste",
        "cost": 4,
        "description": "invoque un tréant en front line pour chaque unités adverses en frontline"
    },
    "Maitrise du blocage": {
        "type": "ritual",
        "classe": "Enki",
        "cost": 2,
        "description": "gagne de l'armure équivalent à l'attaque du combattant utilisé"
    },
    "Préparation au combat": {
        "type": "ritual",
        "classe": "Enlil",
        "cost": 3,
        "description": "donne +2/+2 au combattant utilisé"
    },
    "Roue de la fortune": {
        "type": "ritual",
        "classe": "Inconnu",
        "cost": 5,
        "description": "défausse les 5 premières cartes du deck adverse"
    },
    "Ruée animale": {
        "type": "ritual",
        "classe": "Ishtar",
        "cost": 3,
        "description": "inflige 1 dégats à l'avatar adverse par bête que vous controlez"
    },
    "Prière des profondeurs": {
        "type": "ritual",
        "classe": "Kraken",
        "cost": 2,
        "description": "invoque 2 tentacules en frontline"
    },
    "Rage de combat": {
        "type": "ritual",
        "classe": "Marduk",
        "cost": 2,
        "description": "pioche 1 par combattant allié blessé"
    },
    "Bagarre générale": {
        "type": "ritual",
        "classe": "Marduk",
        "cost": 5,
        "description": "fait combattre le combattant utilisé avec chacun des combattants adverses"
    },
    "Appel de la tombe": {
        "type": "ritual",
        "classe": "Thot",
        "cost": 4,
        "description": "récussite votre dernier combattant mort"
    }
