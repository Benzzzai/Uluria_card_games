...
class Player:
    def __init__(self, deck_name):
        self.name = deck_name
        self.avatar = deck_set[deck_name]["avatar"].copy()
    ...
    def draw_card(self, n=1, card_type=None, archetype=None):
        for _ in range(n):
            if card_type:
